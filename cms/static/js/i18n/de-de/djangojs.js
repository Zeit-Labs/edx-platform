...
'use strict';
{
  ...
  const newcatalog = {
    ...
    " to learn": "lernen",
    "${listPrice}": "${listPrice}",
    "${price}/month {currency}": "${price}/Monat {currency}",
    ...
    "According to our records, you are not enrolled in any courses included in your {programName} program subscription. Enroll in a course from the {i_start}Program Details{i_end} page.": "Laut unseren Unterlagen sind Sie f\u00fcr keinen der Kurse eingeschrieben, die in Ihrem {programName}-Programmabonnement enthalten sind. Melden Sie sich auf der Seite {i_start}Programmdetails{i_end} f\u00fcr einen Kurs an.",
    ...
    "Active subscription": "Aktives Abonnement",
    "Add": "Hinzuf\u00fcgen",
    ...
    "Email cannot be sent to the following users via batch enrollment. They will be allowed to enroll once they register:": "E-Mails k\u00f6nnen nicht \u00fcber die Sammelregistrierung an die folgenden Benutzer gesendet werden. Sie k\u00f6nnen sich anmelden, sobald sie sich angemeldet haben:",
    "Email cannot be sent to the following users via batch enrollment. They will be enrolled once they register:": "E-Mails k\u00f6nnen nicht \u00fcber die Sammelregistrierung an die folgenden Benutzer gesendet werden. Sie werden eingeschrieben, sobald Sie sich angemeldet haben:",
    ...
    "Enroll in a {programName}'s course": "Melden Sie sich f\u00fcr einen Kurs von {programName} an",
    ...
    "Explore subscription options": "Entdecken Sie Abonnementoptionen",
    ...
    "If you had a subscription previously, your payment history is still available on the {a_start}Orders and subscriptions{a_end} page": "Wenn Sie zuvor ein Abonnement hatten, ist Ihr Zahlungsverlauf weiterhin auf der Seite {a_start}Bestellungen und Abonnements{a_end} verf\u00fcgbar",
    ...
    "Inactive subscription": "Inaktives Abonnement",
    ...
    "Monthly program subscriptions {emDash} more flexible, more affordable": "Monatliche Programmabonnements {emDash} flexibler, g\u00fcnstiger",
    "More": "Mehr",
    ...
    "Need help? Check out the {a_start}Learner Help Center{span_start}{icon}{span_end}{a_end} to troubleshoot issues or contact support": "Brauchen Sie Hilfe? Schauen Sie sich das {a_start}Learner Help Center{span_start}{icon}{span_end}{a_end} an, um Probleme zu beheben oder den Support zu kontaktieren",
    ...
    "November": "November",
    "Now": "Jetzt",
    "Now available for many popular programs, affordable monthly subscription pricing can help you manage your budget more effectively. Subscriptions start at {minSubscriptionPrice}/month USD per program, after a 7-day full access free trial. Cancel at any time.": "Die erschwinglichen monatlichen Abonnementpreise sind jetzt f\u00fcr viele beliebte Programme verf\u00fcgbar und k\u00f6nnen Ihnen dabei helfen, Ihr Budget effektiver zu verwalten. Abonnements beginnen bei {minSubscriptionPrice}/Monat USD pro Programm, nach einer 7-t\u00e4gigen kostenlosen Testversion mit Vollzugriff. Jederzeit k\u00fcndbar.",
    ...
    "Pause": "Pause",
    "Pay {subscriptionPrice} after {trialLength}-day free trial": "Zahlen Sie {subscriptionPrice} nach einer 0-t\u00e4gigen kostenlosen Testversion",
    "Pay {subscriptionPrice} for all courses in this program": "Bezahlen Sie {subscriptionPrice} f\u00fcr alle Kurse in diesem Programm",
    "Peer": "Partner",
    ...
    "Please enable discussions for graded units from course authoring app": "Bitte aktivieren Sie Diskussionen f\u00fcr benotete Einheiten aus der Kurserstellungs-App",
    ...
    "Restart my subscription": "Starten Sie mein Abonnement neu",
    "Restart your subscription for {subscriptionPrice}. Your payment history is still available on the {a_start}Orders and subscriptions{a_end} page": "Starten Sie Ihr Abonnement f\u00fcr {subscriptionPrice} neu. Ihr Zahlungsverlauf ist weiterhin auf der Seite {a_start}Bestellungen und Abonnements{a_end} verf\u00fcgbar",
    ...
    "Start {trialLength}-day free trial": "Starten Sie eine 0-t\u00e4gige kostenlose Testversion",
    "Started": "Gestartet",
    ...
    "Subscription trial expires in less than 24 hours": "Die Testversion des Abonnements l\u00e4uft in weniger als 24 Stunden ab",
    ...
    "This subsection is configured as \\\"%(gradingType)s\\\", which doesn't exist in the current grading policy.": "Dieser Unterabschnitt ist als \u201e <span class='notranslate'>%(gradingType)s</span> \u201c konfiguriert, was in der aktuellen Bewertungsrichtlinie nicht vorhanden ist.",
    ...
    "Trial ends {trialEndDate} at {trialEndTime}": "Die Testversion endet am {trialEndDate} um {trialEndTime}",
    ...
    "Upgrade with a subscription": "Upgraden Sie mit einem Abonnement",
    "Upload": "Hochladen",
    ...
    "View program": "Programm ansehen",
    "View your receipts or modify your subscription on the {a_start}Orders and subscriptions{a_end} page": "Sehen Sie sich Ihre Belege an oder \u00e4ndern Sie Ihr Abonnement auf der Seite {a_start}Bestellungen und Abonnements{a_end}",
    ...
    "You have an active subscription to the {programName} program but are not enrolled in any courses. Enroll in a remaining course and enjoy verified access.": "Sie haben ein aktives Abonnement f\u00fcr das Programm {programName}, sind aber f\u00fcr keinen Kurs eingeschrieben. Melden Sie sich f\u00fcr einen verbleibenden Kurs an und genie\u00dfen Sie verifizierten Zugang.",
    ...
    "Your next billing date is {currentPeriodEnd}": "Ihr n\u00e4chstes Rechnungsdatum ist {currentPeriodEnd}",
    ...
    "Your {programName} trial will expire at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": "Ihre {programName}-Testversion l\u00e4uft am {trialEndDate} um {trialEndTime} ab und die hinterlegte Karte wird mit {subscriptionPrice} belastet.",
    ...
    "{subscriptionPrice} subscription after trial ends. Cancel anytime.": "{subscriptionPrice}-Abonnement nach Ablauf der Testversion. Jederzeit k\u00fcndbar.",
    "{subscriptionPrice} subscription. Cancel anytime.": "{subscriptionPrice} Abonnement. Jederzeit k\u00fcndbar.",
