...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "${listPrice}": "${listPrice}",
    "${price}/month {currency}": "${prezzo}/mese {currency}",
    ...
    "According to our records, you are not enrolled in any courses included in your {programName} program subscription. Enroll in a course from the {i_start}Program Details{i_end} page.": "In base ai dati in nostro possesso, non sei iscritto a nessun corso incluso nella tua iscrizione al programma {programName}. Iscriviti a un corso dalla pagina {i_start}Dettagli programma{i_end}.",
    "Account": "Account",
    ...
    "Active subscription": "Abbonamento attivo",
    "Add": "Aggiungi",
    ...
    "Bottom": "In basso",
    "Browse": "Cerca",
    "Browse recently launched courses and see what's new in your favorite subjects.": "Sfoglia i corsi avviati recentemente e scopri le novit\u00e0 nelle tue materie preferite. ",
    ...
    "Discussions enabled": "Discussioni abilitate",
    "Dismiss": "Chiudi",
    ...
    "Email cannot be sent to the following users via batch enrollment. They will be allowed to enroll once they register:": "L&#39;e-mail non pu\u00f2 essere inviata ai seguenti utenti tramite la registrazione batch. Potranno immatricolarsi previa registrazione:",
    "Email cannot be sent to the following users via batch enrollment. They will be enrolled once they register:": "L&#39;e-mail non pu\u00f2 essere inviata ai seguenti utenti tramite la registrazione batch. Saranno iscritti una volta registrati:",
    ...
    "Enable summaries": "Abilita riepiloghi",
    "Enabled": "Abilitato",
    "Encoding": "Codifica",
    ...
    "Enroll in a {programName}'s course": "Iscriviti a un corso di {programName}",
    "Enrolled": "Iscritto",
    ...
    "Explore subscription options": "Esplora le opzioni di abbonamento",
    ...
    "If you had a subscription previously, your payment history is still available on the {a_start}Orders and subscriptions{a_end} page": "Se avevi un abbonamento in precedenza, la tua cronologia dei pagamenti \u00e8 ancora disponibile nella pagina {a_start}Ordini e abbonamentis{a_end}",
    ...
    "Inactive subscription": "Abbonamento inattivo",
    ...
    "Monthly program subscriptions {emDash} more flexible, more affordable": "Abbonamenti mensili ai programmi {emDash} pi\u00f9 flessibili, pi\u00f9 convenienti",
    "More": "Pi\u00f9",
    "More opportunities for you": "Pi\u00f9 opportunit\u00e0 per te",
    ...
    "Need help? Check out the {a_start}Learner Help Center{span_start}{icon}{span_end}{a_end} to troubleshoot issues or contact support": "Ho bisogno di aiuto? Consulta il {a_start}Centro assistenza per gli studenti{span_start}{icon}{span_end}{a_end} per risolvere problemi o contattare l&#39;assistenza",
    ...
    "November": "Novembre",
    "Now": "Adesso",
    "Now available for many popular programs, affordable monthly subscription pricing can help you manage your budget more effectively. Subscriptions start at {minSubscriptionPrice}/month USD per program, after a 7-day full access free trial. Cancel at any time.": "Ora disponibile per molti programmi popolari, il prezzo conveniente dell&#39;abbonamento mensile pu\u00f2 aiutarti a gestire il tuo budget in modo pi\u00f9 efficace. Gli abbonamenti partono da $029fe68b2f6c7z0/mese per programma, dopo una prova gratuita di 7 giorni di accesso completo. Annulla in qualsiasi momento.",
    ...
    "Pause": "Pausa",
    "Pay {subscriptionPrice} after {trialLength}-day free trial": "Paga {subscriptionPrice} dopo un{trialLength} giorni di prova gratuita",
    "Pay {subscriptionPrice} for all courses in this program": "Paga {subscriptionPrice} per tutti i corsi di questo programma",
    "Peer": "Peer",
    ...
    "Please enable discussions for graded units from course authoring app": "Abilita le discussioni per le unit\u00e0 valutate dall&#39;app di creazione del corso",
    ...
    "Restart my subscription": "Riavvia il mio abbonamento",
    "Restart your subscription for {subscriptionPrice}. Your payment history is still available on the {a_start}Orders and subscriptions{a_end} page": "Riavvia il tuo abbonamento per {subscriptionPrice}. La tua cronologia dei pagamenti \u00e8 ancora disponibile nella pagina {a_start}Ordini e abbonamentis{a_end}",
    ...
    "Start {trialLength}-day free trial": "Avvia una prova gratuita di 0 giorni a0e84ea6267253z",
    "Started": "Avviato",
    ...
    "Subscript": "Pedice",
    "Subscription trial expires in less than 24 hours": "La prova dell&#39;abbonamento scade tra meno di 24 ore",
    ...
    "The following required files were imported to this course:": "I seguenti file obbligatori sono stati importati in questo corso:",
    ...
    "This subsection is configured as \\\"%(gradingType)s\\\", which doesn't exist in the current grading policy.": "Questa sottosezione \u00e8 configurata come \\&quot; <span class='notranslate'>%(gradingType)s</span> \\&quot;, che non esiste nell&#39;attuale politica di valutazione.",
    ...
    "Trial ends {trialEndDate} at {trialEndTime}": "La prova termina {trialEndDate} alle {trialEndTime}",
    "Trial subscription": "Abbonamento di prova",
    ...
    "Upgrade with a subscription": "Aggiorna con un abbonamento",
    "Upload": "Carica",
    ...
    "View program": "Visualizza programma",
    "View your receipts or modify your subscription on the {a_start}Orders and subscriptions{a_end} page": "Visualizza le tue ricevute o modifica il tuo abbonamento nella pagina {a_start}Ordini e abbonamentis{a_end}",
    ...
    "We've added 500+ learning opportunities to create one of the world's most comprehensive free-to-degree online learning platforms.": "Abbiamo aggiunto oltre 500 opportunit\u00e0 di apprendimento per creare una delle piattaforme di apprendimento online gratuite pi\u00f9 complete al mondo.",
    ...
    "You have an active subscription to the {programName} program but are not enrolled in any courses. Enroll in a remaining course and enjoy verified access.": "Hai un abbonamento attivo al programma {programName} ma non sei iscritto a nessun corso. Iscriviti a un corso rimanente e goditi l&#39;accesso verificato.",
    ...
    "You have successfully completed all the requirements for the %(title)s %(type)s.": "Hai completato con successo tutti i requisiti per %(title)s %(type)s.",
    ...
    "You must have at least one undroppable <%- types %> assignment.": "Devi avere almeno un&#39;assegnazione &lt;%-types %&gt; non eliminabile.",
    ...
    "Your next billing date is {currentPeriodEnd}": "La tua prossima data di fatturazione \u00e8 {currentPeriodEnd}",
    ...
    "Your {programName} trial will expire at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": "Il periodo di prova di {programName} scadr\u00e0 alle {trialEndTime} in data {trialEndDate} e verr\u00e0 addebitato l&#39;importo {subscriptionPrice} sulla carta in archivio.",
    ...
    "{assignment_count} {type} assignment(s) found:": "{assignment_count} {type} compiti trovati:",
    ...
    "{subscriptionPrice} subscription after trial ends. Cancel anytime.": "{subscriptionPrice} abbonamento al termine del periodo di prova. Annulla in qualsiasi momento.",
    "{subscriptionPrice} subscription. Cancel anytime.": "abbonamento {subscriptionPrice}. Annulla in qualsiasi momento.",
