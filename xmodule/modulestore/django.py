...
from xmodule.waffle import ENABLE_EXTERNAL_XBLOCK_TRANSLATIONS
...
class XBlockI18nService:
    ...
    def get_python_locale_directory(block):
        ...
        This function works in two modes:
            1. With ENABLE_EXTERNAL_XBLOCK_TRANSLATIONS enabled it loads OEP-58 external translations.
            2. With ENABLE_EXTERNAL_XBLOCK_TRANSLATIONS disabled it uses the old in-xblock translations which are
    ...
    def get_javascript_locale_path(block):
        ...
        This function only works With ENABLE_EXTERNAL_XBLOCK_TRANSLATIONS waffle switch enabled.
        """
        xblock_class = getattr(block, 'unmixed_class', block.__class__)
        xblock_resource = xblock_class.__module__
        selected_language = get_language()
