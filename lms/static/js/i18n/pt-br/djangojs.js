...
'use strict';
{
  ...
  const newcatalog = {
    ...
    " and ": "e",
    " learner account cannot be found and has not been added to the exception list": "a conta do aluno n\u00e3o pode ser encontrada e n\u00e3o foi adicionada \u00e0 lista de exce\u00e7\u00f5es",
    " learner accounts cannot be found and have not been added to the exception list": "as contas do aluno n\u00e3o podem ser encontradas e n\u00e3o foram adicionadas \u00e0 lista de exce\u00e7\u00f5es",
    " learner already appears on the exception list in this course": "o aluno j\u00e1 aparece na lista de exce\u00e7\u00f5es neste curso",
    " learner encountered an unknown error": "aluno encontrou um erro desconhecido",
    " learner has an active certificate invalidation in this course and has not been added to the exception list": "o aluno tem uma invalida\u00e7\u00e3o de certificado ativa neste curso e n\u00e3o foi adicionado \u00e0 lista de exce\u00e7\u00f5es",
    " learner is not enrolled in this course and has not been added to the exception list": "o aluno n\u00e3o est\u00e1 matriculado neste curso e n\u00e3o foi adicionado \u00e0 lista de exce\u00e7\u00f5es",
    " learner was successfully added to the exception list": "aluno foi adicionado com sucesso \u00e0 lista de exce\u00e7\u00f5es",
    " learners already appear on the exception list in this course": "os alunos j\u00e1 aparecem na lista de exce\u00e7\u00f5es neste curso",
    " learners are not enrolled in this course and have not added to the exception list": "os alunos n\u00e3o est\u00e3o matriculados neste curso e n\u00e3o foram adicionados \u00e0 lista de exce\u00e7\u00f5es",
    " learners encountered unknown errors": "os alunos encontraram erros desconhecidos",
    " learners have an active certificate invalidation in this course and have not been added to the exception list": "os alunos t\u00eam uma invalida\u00e7\u00e3o de certificado ativa neste curso e n\u00e3o foram adicionados \u00e0 lista de exce\u00e7\u00f5es",
    " learners were successfully added to exception list": "os alunos foram adicionados com sucesso \u00e0 lista de exce\u00e7\u00f5es",
    ...
    " to learn": "aprender",
    "${listPrice}": "${listPrice}",
    "${price}/month {currency}": "${pre\u00e7o}/m\u00eas <span class='notranslate'>{currency}</span>",
    ...
    "According to our records, you are not enrolled in any courses included in your {programName} program subscription. Enroll in a course from the {i_start}Program Details{i_end} page.": "De acordo com nossos registros, voc\u00ea n\u00e3o est\u00e1 matriculado em nenhum curso inclu\u00eddo em sua assinatura do programa {programName}. Inscreva-se em um curso na p\u00e1gina {i_start}Detalhes do programa <span class='notranslate'>{i_end}</span> .",
    "Account": "Conta",
    ...
    "An answer option has been left blank. Please review and edit the component.": "Uma op\u00e7\u00e3o de resposta foi deixada em branco. Revise e edite o componente.",
    ...
    "As part of the verification process, you take a photo of both your face and a photo ID. Our authorization service confirms your identity by comparing the photo you take with the photo on your ID.": "Como parte do processo de verifica\u00e7\u00e3o, voc\u00ea tira uma foto do seu rosto e do seu documento de identifica\u00e7\u00e3o. Nosso servi\u00e7o de autoriza\u00e7\u00e3o confirma sua identidade comparando a foto que voc\u00ea tirou com a foto em sua identidade.",
    ...
    "Before proceeding, please {htmlStart}{emailMsg}{htmlEnd}.": "Antes de prosseguir, {htmlStart}{emailMsg} <span class='notranslate'>{htmlEnd}</span> .",
    ...
    "Cohort assignment not allowed: {email_or_username}": "Atribui\u00e7\u00e3o de coorte n\u00e3o permitida: <span class='notranslate'>{email_or_username}</span>",
    "Cohorts": "Grupos",
    ...
    "Discussions enabled": "Discuss\u00f5es ativadas",
    "Dismiss": "Rejeitar",
    ...
    "Editable": "Edit\u00e1vel",
    "Editing access for: {title}": "Acesso de edi\u00e7\u00e3o para: {title}",
    ...
    "Email cannot be sent to the following users via batch enrollment. They will be allowed to enroll once they register:": "O e-mail n\u00e3o pode ser enviado para os seguintes usu\u00e1rios por meio de inscri\u00e7\u00e3o em lote. Eles ser\u00e3o autorizados a se inscrever uma vez que se registrarem:",
    "Email cannot be sent to the following users via batch enrollment. They will be enrolled once they register:": "O e-mail n\u00e3o pode ser enviado para os seguintes usu\u00e1rios por meio de inscri\u00e7\u00e3o em lote. Eles ser\u00e3o inscritos assim que se registrarem:",
    ...
    "Enable Course Highlight Emails": "Ativar e-mails de destaque do curso",
    ...
    "Enroll in a {programName}'s course": "Inscreva-se em um curso de <span class='notranslate'>{programName}</span>",
    ...
    "If a learner starts on {startDate}, this subsection will be due on {projectedDueIn}.": "Se um aluno come\u00e7ar em {startDate}, esta subse\u00e7\u00e3o vencer\u00e1 em <span class='notranslate'>{projectedDueIn}</span> .",
    ...
    "If you require assistance with taking either photo for submission, contact %(platformName)s support for additional suggestions.": "Se voc\u00ea precisar de ajuda para tirar qualquer uma das fotos para enviar, entre em contato com 1%(platformName)s suporte para sugest\u00f5es adicionais.",
    ...
    "More": "Mais",
    "More opportunities for you": "Mais oportunidades para voc\u00ea",
    ...
    "New file(s) added to Files & Uploads.": "Novo(s) arquivo(s) adicionado(s) a Arquivos e uploads.",
    ...
    "Only <%- fileTypes %> files can be uploaded. Please select a file ending in <%- (fileExtensions) %> to upload.": "Somente arquivos &lt;%- fileTypes %&gt; podem ser carregados. Por favor, selecione um arquivo terminando em &lt;%- (fileExtensions) %&gt; para carregar.",
    ...
    "Please enable discussions for graded units from course authoring app": "Ative as discuss\u00f5es para unidades avaliadas no aplicativo de autoria do curso",
    ...
    "Recommendations for you": "Recomenda\u00e7\u00f5es para voc\u00ea",
    ...
    "Studio's having trouble parsing the problem component's content": "O Studio est\u00e1 tendo problemas para analisar o conte\u00fado do componente problem\u00e1tico",
    ...
    "Submitted": "Enviado",
    "Subscript": "Subscrito",
    "Subscription trial expires in less than 24 hours": "A avalia\u00e7\u00e3o da assinatura expira em menos de 24 horas",
    "Subsection": "Subse\u00e7\u00e3o",
    ...
    "The combined length of the organization, course number, and course run fields cannot be more than <%- limit %> characters.": "O comprimento combinado dos campos organiza\u00e7\u00e3o, n\u00famero do curso e execu\u00e7\u00e3o do curso n\u00e3o pode ter mais de &lt;%- limit %&gt; caracteres.",
    ...
    "The minimum number of weeks this subsection can be due in is 1 week from the learner enrollment date.": "O n\u00famero m\u00ednimo de semanas para o vencimento desta subse\u00e7\u00e3o \u00e9 de 1 semana a partir da data de inscri\u00e7\u00e3o do aluno.",
    ...
    "The number of {type} assignments defined here does not match the current number of {type} assignments in the course:": "O n\u00famero de atribui\u00e7\u00f5es <span class='notranslate'>{type}</span> definido aqui n\u00e3o corresponde ao n\u00famero atual de atribui\u00e7\u00f5es <span class='notranslate'>{type}</span> no curso:",
    "The number of {type} assignments in the course matches the number defined here.": "O n\u00famero de atribui\u00e7\u00f5es <span class='notranslate'>{type}</span> no curso corresponde ao n\u00famero definido aqui.",
    ...
    "There are no assignments of this type in the course.": "N\u00e3o h\u00e1 tarefas deste tipo no curso.",
    ...
    "This subsection is configured as \\\"%(gradingType)s\\\", which doesn't exist in the current grading policy.": "Esta subse\u00e7\u00e3o est\u00e1 configurada como \\&quot; <span class='notranslate'>%(gradingType)s</span> \\&quot;, que n\u00e3o existe na pol\u00edtica de notas atual.",
    "This subsection was released to learners as a proctored exam, but was reverted back to a basic or timed exam. You may not configure it as a proctored exam now. Contact edX Support for assistance.": "Esta subse\u00e7\u00e3o foi liberada para os alunos como um exame supervisionado, mas foi revertida para um exame b\u00e1sico ou cronometrado. Voc\u00ea n\u00e3o pode configur\u00e1-lo como um exame supervisionado agora. Entre em contato com o suporte da edX para obter assist\u00eancia.",
    ...
    "To access the courses available to you through {enterpriseName}, visit the {enterpriseName} dashboard.": "Para acessar os cursos dispon\u00edveis por meio de <span class='notranslate'>{enterpriseName}</span> , visite o painel <span class='notranslate'>{enterpriseName}</span> .",
    ...
    "Upload a new PDF to \u201c<%- name %>\u201d": "Carregue um novo PDF para \u201c&lt;%- nome %&gt;\u201d",
    ...
    "Use your webcam to take a photo of your ID.": "use sua webcam para tirar uma foto do seu documento de identidade",
    ...
    "We've added 500+ learning opportunities to create one of the world's most comprehensive free-to-degree online learning platforms.": "Adicionamos mais de 500 oportunidades de aprendizado para criar uma das plataformas de aprendizado on-line gratuitas mais abrangentes do mundo.",
    ...
    "Xpert unit summaries": "Resumos da unidade Xpert",
    ...
    "You have access to the {enterpriseName} dashboard": "Voc\u00ea tem acesso ao painel {enterpriseName}",
    "You have already verified your ID!": "Voc\u00ea j\u00e1 verificou a sua identifica\u00e7\u00e3o",
    "You have an active subscription to the {programName} program but are not enrolled in any courses. Enroll in a remaining course and enjoy verified access.": "Voc\u00ea tem uma assinatura ativa do programa <span class='notranslate'>{programName}</span> , mas n\u00e3o est\u00e1 matriculado em nenhum curso. Inscreva-se em um curso restante e aproveite o acesso verificado.",
    "You have been logged out of your account. Click Okay to log in again now. Click Cancel to stay on this page (you must log in again to save your work).": "Voc\u00ea foi desconectado da sua conta. Clique em OK para fazer login novamente agora. Clique em Cancelar para permanecer nesta p\u00e1gina (voc\u00ea deve fazer login novamente para salvar seu trabalho).",
    ...
    "You may need to update a file(s) manually": "Voc\u00ea pode precisar atualizar um arquivo(s) manualmente",
    ...
    "Your {programName} trial will expire at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": "Sua avalia\u00e7\u00e3o de {programName} expirar\u00e1 em {trialEndTime} em {trialEndDate} e o cart\u00e3o registrado ser\u00e1 cobrado <span class='notranslate'>{subscriptionPrice}</span> .",
    ...
    "weeks from learner enrollment date": "semanas a partir da data de inscri\u00e7\u00e3o do aluno",
    ...
    "{assignment_count} {type} assignment(s) found:": "{assignment_count} <span class='notranslate'>{type}</span> atribui\u00e7\u00e3o(\u00f5es) encontrada(s):",
    ...
    "{paragraph}=p;{preformatted}=pre;{heading3}=h3;{heading4}=h4;{heading5}=h5;{heading6}=h6": "{paragraph}=p;{preformatted}=pre;{heading3}=h3;{heading4}=h4;{heading5}=h5; <span class='notranslate'>{heading6}</span> =h6",
